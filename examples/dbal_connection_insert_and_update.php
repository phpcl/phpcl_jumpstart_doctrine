...
$date1 = sprintf('2020-%02d-%02d %02d:00:00', rand(1,12), rand(1,28), rand(8,20));
$date2 = sprintf('2020-%02d-%02d %02d:00:00', rand(1,12), rand(1,28), rand(8,20));
$hId   = rand(1,95);
$key   = 'PLT-BRN-SOC-' . rand(100,999);
$data = [
  'event_key'  => $key,
  'event_name' => 'Planet Burning Society',
  'event_date' => $date1,
  'hotel_id'  => $hId
];
